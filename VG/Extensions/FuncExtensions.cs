...
namespace VG.Extensions
{
    public static class FuncExtensions
    {
        ...
        public static IEnumerable<TResult> Select<TSource, TResult> (this Func<TSource> source, Func<TSource, TResult> selector)
        {
        ...
        public static IEnumerable<TResult> SelectMany<TSource, TResult> (this Func<TSource> source, Func<TSource, IEnumerable<TResult>> selector)
        {
            return source.GetInvocationList ()
                .Cast<Func<TSource>> ()
                .Select (method => method ())
