...
namespace VG.Extensions
{
    ...
    public static class VectorExtensions
    {
        ...
        {
            float signedAngleInRadians = signedAngle * Mathf.Deg2Rad;
        ...
        public static Vector2 PositionToScreenPoint (this Transform transform, Camera camera = null)
        {
            ...
            else
            {
                ...
                return camera ? (Vector2) camera.WorldToScreenPoint (transform.position) : Vector2.zero;
            }
        ...
        /// </summary>
        public static Vector2 WorldPointToAnchorPos (this RectTransform rectTransform, Vector3 worldPoint, Camera camera = null)
        {
            if (rectTransform)
            {
                if (camera == null ||
        ...
        /// </summary>
        public static Vector2 ScreenPointToAnchorPos (this RectTransform rectTransform, Vector2 screenPoint, Camera camera = null)
        {
            if (rectTransform)
            {
                if (camera == null ||
                ...
                RectTransformUtility.ScreenPointToLocalPointInRectangle (rectTransform, screenPoint, camera, out Vector2 offset);
